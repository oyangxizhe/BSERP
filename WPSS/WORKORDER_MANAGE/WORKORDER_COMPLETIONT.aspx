<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WORKORDER_COMPLETIONT.aspx.cs" Inherits="WPSS.WORKORDER_MANAGE.WORKORDER_COMPLETIONT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑工单完工入库信息</title>
...
<span style =" margin-left :0px;"><a  href="javascript:f13100202('Text4','');">选择 </a></span> 
 <span  style =" margin-left :5px"><asp:Label ID="Label1" runat="server" Text="" ></asp:Label></span>
       ...
       <div class ="c14060302">
   (可入库量 = 累计领用套数-累计退料套数-累计物料报废套数-累计工单入库数量-累计工单报废数量) 
           </div>
<div class ="c14060302">
   (未入库量 =工单数量 - 累计工单入库数量-累计工单报废数量)
           </div>
<div id="i13111001" class ="c13102201">
           ...
           <asp:GridView ID="GridView1" runat="server" 
                    ...
                    onrowdatabound="GridView1_RowDataBound" 
                        ...
                        CssClass ="c14062201"  onrowdeleting="GridView1_RowDeleting"
                   >
             ...
             <asp:TemplateField HeaderText="成品料号">
               ...
               <asp:TemplateField HeaderText="可入库量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox17" runat="server" Text='<%#Eval ("可入库量") %>' CssClass ="c14071701"></asp:TextBox>                     
                </ItemTemplate>
                    <HeaderStyle Width="4%" />
                 <ItemStyle Width="4%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle Width="4%"  />
                        ...
                        <asp:TemplateField HeaderText="入库单位">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox15" runat="server" Text='<%#Eval ("入库单位") %>' CssClass ="c14071616"></asp:TextBox>                     
                </ItemTemplate>
                   <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField>
               ...
               <asp:TextBox ID="TextBox2" runat="server"  Text='<%#Eval ("品号") %>' CssClass="c14071609" ></asp:TextBox>         
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox6" runat="server" Text='<%#Eval ("工单数量") %>' ReadOnly ="true"  CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                  <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField>
             <asp:TemplateField HeaderText="未入库量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox7" runat="server" Text='<%#Eval ("未入库数量") %>'  CssClass ="c14071701"></asp:TextBox>                     
                </ItemTemplate>
                  <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox8" runat="server" Text='<%#Eval ("累计入库数量") %>' ReadOnly ="true"  CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="8%" />
                 <ItemStyle Width="8%"  />
            </asp:TemplateField>
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox16" runat="server" Text='<%#Eval ("累计报废数量") %>' ReadOnly ="true" Width ="80px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                <HeaderStyle Width="8%" />
                 <ItemStyle Width="8%"  />
            </asp:TemplateField>
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox14" runat="server" Text='<%#Eval ("本入库单累计入库数量") %>'  ReadOnly ="true" Width ="130px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="8%" />
                 <ItemStyle Width="8%"  />
            </asp:TemplateField> 
