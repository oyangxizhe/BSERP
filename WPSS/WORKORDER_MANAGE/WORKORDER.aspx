<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WORKORDER.aspx.cs" Inherits="WPSS.WORKORDER_MANAGE.WORKORDER" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("工单号") %>','<%#Eval ("客户名称") %>','<%#Eval ("ID") %>',
         '<%#Eval ("料号") %>','<%#Eval ("品名") %>','<%#Eval ("客户料号") %>','<%#Eval ("可领料套数") %>','<%#Eval ("可退料套数") %>',
         '<%#Eval ("可报废套数") %>')">
                       选取</a>
                   </ItemTemplate>
                            <HeaderStyle Width="4%" />
             ...
             <asp:BoundField DataField="ID" HeaderText="ID" >
               ...
               <asp:BoundField DataField="料号" HeaderText="厂内成品料号" >
                              <ItemStyle CssClass ="c14072705" ForeColor="#595d5a" />
                           ...
                           <asp:BoundField DataField="客户料号" HeaderText="客户料号" >
                             ...
                             <asp:BoundField DataField="品名" HeaderText="品名" >
                              <ItemStyle CssClass="c14072702"  ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center"/>
                          </asp:BoundField>
                            <asp:BoundField DataField="状态" HeaderText="状态" >
                              <ItemStyle CssClass="status"  ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" />
                          </asp:BoundField>
                           <asp:BoundField DataField="BOM编号" HeaderText="BOM编号" >
                              <ItemStyle CssClass ="c14072705"  />
