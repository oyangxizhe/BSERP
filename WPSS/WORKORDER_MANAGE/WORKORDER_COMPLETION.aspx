<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WORKORDER_COMPLETION.aspx.cs" Inherits="WPSS.WORKORDER_MANAGE.WORKORDER_COMPLETION" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>工单完工入库作业</title>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" Width="98%" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("WMID") %>');">选取</a>
                   </ItemTemplate>
                 ...
                 <asp:BoundField DataField="WOID" HeaderText="工单号" >
                            ...
                            <asp:BoundField DataField="WORKORDER_STATUS_MST" HeaderText="状态" >
                              <ItemStyle Width="100px" ForeColor="#595d5a" />
                                 ...
                                 <asp:BoundField DataField="COMPLETION_DATE" HeaderText="入库日期"
