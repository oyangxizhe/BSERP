<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WORKORDER_REPICKINGT.aspx.cs" Inherits="WPSS.WORKORDER_MANAGE.WORKORDER_REPICKINGT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑工单成套退料作业</title>
  ...
  <a  href="javascript:f13100202('Text2','');">
   ...
   <asp:LinkButton ID="btnSure" runat="server" onclick="btnSure_Click"   ForeColor ="Blue">确定</asp:LinkButton>
     ...
     <div  class="c14120504"  id ="Div8">
         <input id="Text6" type="text" runat="server" class="c14120108"/>
    ...
    <div class="c13101903" id ="Div32">
     ...
     <div class="c14120110" id ="Div33">
       ...
       <div  class="c14120504" id ="Div11">
         <input id="Text3" type="text" runat="server" onclick ="f13100202('Text3')" class ="c14120107"/> 
...
<span style =" margin-left :0px;"><a  href="javascript:f13100202('Text4','');">选择 </a></span> 
 <span  style =" margin-left :5px"><asp:Label ID="Label1" runat="server" Text="" ></asp:Label></span>
  ...
  <div class="c13101903" id ="Div38">
                          退料套数</div>
   <div class="c14120504" id ="Div39">
         <input id="Text10" type="text" runat="server" class ="c14120107"/> 
       <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="Text10" Text="必填" runat="server" />
         </div>
           </div>
              <div class ="c14060302">
                  (可退料套数 = 累计领料套数 - 累计退料套数 - 累计报废套数-累计工单入库数量-累计工单报废数量) 
           </div>
           <div class ="c14060302">
               (退料数量默认 = 退料单包装退料量 - 本退料单累计退料量)
           </div>
<div id="i13111001" class ="c14061302">
           <asp:GridView ID="GridView1" runat="server" 
                    AllowSorting="True"   
                    onrowdatabound="GridView1_RowDataBound" 
                        AutoGenerateColumns="False"  PageSize="15" 
                           CssClass ="c14070501" onrowdeleting="GridView1_RowDeleting"
                   >
                ...
                <ItemTemplate >
                  <asp:TextBox ID="TextBox1" runat="server"  Text='<%#Eval ("项次") %>'  CssClass="c14071609"  ></asp:TextBox>   
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox3" runat="server"  Text='<%#Eval ("子料号") %>' ReadOnly ="true" CssClass="c14071609" ></asp:TextBox>                     
                </ItemTemplate>
                     <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField> 
               <asp:TemplateField HeaderText="类别名称">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox4" runat="server" Text='<%#Eval ("子品名") %>' ReadOnly ="true" CssClass="c14071610"></asp:TextBox>                     
                </ItemTemplate>
                      <HeaderStyle Width="4%" />
                 <ItemStyle Width="4%"  />
            </asp:TemplateField> 
              
                 <asp:TemplateField HeaderText="可退料量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox14" runat="server" Text='<%#Eval ("可退料量") %>' ReadOnly ="true" CssClass ="c14071701"></asp:TextBox>                     
                </ItemTemplate>
                        <HeaderStyle Width="3%" />
                 <ItemStyle Width="3%"  />
            </asp:TemplateField> 
                     <asp:TemplateField HeaderText="退料数量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox9" runat="server" Text='<%#Eval ("退料数量") %>'  CssClass ="c13112302"></asp:TextBox>                     
                </ItemTemplate>
                           <HeaderStyle Width="3%" />
                 <ItemStyle Width="3%"  />
            </asp:TemplateField> 
                  <asp:TemplateField HeaderText="退料单位">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox16" runat="server" Text='<%#Eval ("退料单位") %>'    ReadOnly ="true" CssClass ="c14071616">&gt;</asp:TextBox>                     
                </ItemTemplate>
                         <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField>
                ...
                <ItemTemplate >
                <asp:TextBox ID="TextBox2" runat="server"  Text='<%#Eval ("子ID") %>' ReadOnly ="true" CssClass="c14071609"  ></asp:TextBox>   
                </ItemTemplate>
                     <HeaderStyle Width="4%" />
                 <ItemStyle Width="4%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox5" runat="server" Text='<%#Eval ("子规格") %>' ReadOnly ="true"  CssClass ="c14070203" ></asp:TextBox>                     
                </ItemTemplate>
                   <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField> 
              <asp:TemplateField HeaderText="品牌">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox6" runat="server" Text='<%#Eval ("品牌") %>' ReadOnly ="true"  CssClass ="c14070203" ></asp:TextBox>                     
                </ItemTemplate>
                   <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField> 
        ...
        <asp:TemplateField HeaderText="物料料号">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox7" runat="server" Text='<%#Eval ("子客户料号") %>'  CssClass ="c14070103"></asp:TextBox>                     
                </ItemTemplate>
               <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField> 
                    <asp:TemplateField HeaderText="生产用量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox8" runat="server" Text='<%#Eval ("生产用量") %>' ReadOnly ="true"  CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                  <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField>
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox91" runat="server" Text='<%#Eval ("BOM单位") %>' ReadOnly ="true"  CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                  <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField>
                        <asp:TemplateField HeaderText="工单包装领用量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox23" runat="server" Text='<%#Eval ("工单包装领用量") %>'  ReadOnly ="true" 
                  CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                   <HeaderStyle Width="8%" />
                 <ItemStyle Width="8%"  />
            </asp:TemplateField> 
                   <asp:TemplateField HeaderText="累计领料量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox111" runat="server" Text='<%#Eval("累计领料量")%>'  width="100px"  CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                  <HeaderStyle Width="7%" />
                 <ItemStyle Width="7%"  />
            </asp:TemplateField>
            
                 <asp:TemplateField HeaderText="累计退料量"   >
                <ItemTemplate >
                 <asp:TextBox ID="TextBox131" runat="server" Text='<%#Eval ("累计退料量") %>' width="100px"  CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                    <HeaderStyle Width="7%" />
                 <ItemStyle Width="7%"  />
            </asp:TemplateField>
               <asp:TemplateField HeaderText="累计报废量"   >
                <ItemTemplate >
                 <asp:TextBox ID="TextBox17" runat="server" Text='<%#Eval ("累计报废量") %>' width="100px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                    <HeaderStyle Width="7%" />
                 <ItemStyle Width="7%"  />
            </asp:TemplateField>
                  <asp:TemplateField HeaderText="工单累计入库耗用量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox121" runat="server" Text='<%#Eval("工单入库累计耗用量")%>'  width="120px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                   <HeaderStyle Width="10%" />
                 <ItemStyle Width="10%"  />
            </asp:TemplateField>
                  <asp:TemplateField HeaderText="工单累计报废耗用量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox18" runat="server" Text='<%#Eval("工单报废累计耗用量")%>'  width="120px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                      <HeaderStyle Width="10%" />
                 <ItemStyle Width="10%"  />
            </asp:TemplateField>
              <asp:TemplateField HeaderText="退料单包装退料量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox101" runat="server" Text='<%#Eval ("退料单包装退料量") %>'  width="120px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                        <HeaderStyle Width="10%" />
                 <ItemStyle Width="10%"  />
            </asp:TemplateField>
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox20" runat="server" Text='<%#Eval ("库存单位") %>' width="120px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                      <HeaderStyle Width="4%" />
                 <ItemStyle Width="4%"  />
            </asp:TemplateField>
                        <asp:TemplateField HeaderText="本退料单累计退料量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox21" runat="server" Text='<%#Eval ("本退料单累计退料量") %>' width="120px" 
                  CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                     <HeaderStyle Width="10%" />
                 <ItemStyle Width="10%"  />
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox13" runat="server"  width="120px" CssClass ="c13120501"></asp:TextBox>                     
                </ItemTemplate>
                       <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField>
          ...
          function f13100202(obj, obj1) {
              ...
              if (obj == "Text5") {
                  ...
                  if (dlgResult != undefined) {
                      ...
                      document.getElementById("Text10").value = dlgResult[7]; /*allow repicking count*/
                  }
                  ...
                  if (dlgResult != undefined) {
                      ...
                      for (j = 1; j < tr1.length; j++) {
                          if (obj1 == j) {
                              var v6 = tr1[j].getElementsByTagName("td")[8].getElementsByTagName("input")[0];
