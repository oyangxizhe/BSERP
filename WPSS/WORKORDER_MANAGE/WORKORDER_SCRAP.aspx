<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WORKORDER_SCRAP.aspx.cs" Inherits="WPSS.WORKORDER_MANAGE.WORKORDER_SCRAP" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" Width="98%" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("WSID") %>');">选取</a>
                   </ItemTemplate>
                 ...
                 <asp:BoundField DataField="WOID" HeaderText="工单号" >
                            ...
                            <asp:BoundField DataField="WORKORDER_STATUS_MST" HeaderText="状态" >
                              <ItemStyle Width="100px" ForeColor="#595d5a" />
                                 ...
                                 <asp:BoundField DataField="SCRAP_DATE" HeaderText="报废日期"
                                 DataFormatString="{0:yyyy-MM-dd}" >
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="100px" HorizontalAlign="Center" />
                          </asp:BoundField>
                             <asp:BoundField DataField="GODER" HeaderText="报废员" >
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="100px" HorizontalAlign="Center" />
                          </asp:BoundField>
...
<script type="text/javascript" language="javascript">
    ...
    window.onload = function onload1() {
        ...
        if (Invocation1 != "") {
            ...
            document.getElementById("i14070401").style.display = "block";

        }
        else {
            document.getElementById("i14031701").style.display = "none";
            document.getElementById("i14070401").style.display = "none";
