<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WORKORDER_MATERIEL_SCRAPT.aspx.cs" Inherits="WPSS.WORKORDER_MANAGE.WORKORDER_MATERIEL_SCRAPT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑工单物料报废单</title>
...
<span style =" margin-left :0px;"><a  href="javascript:f13100202('Text4','');">选择 </a></span> 
 <span  style =" margin-left :5px"><asp:Label ID="Label1" runat="server" Text="" ></asp:Label></span>
  ...
  <div class ="c14060302">
      (可报废套数 = 累计领料套数 - 累计退料套数 - 累计报废套数-累计工单入库数量-累计工单报废数量) 
           </div>
           <div class ="c14060302">
               (报废数量默认 (报废数量默认 = 报废单包装报废量 - 本报废单累计报废量)
           </div>
<div id="i13111001" class ="c14062101">
           <asp:GridView ID="GridView1" runat="server" 
                    AllowSorting="True"   
                    onrowdatabound="GridView1_RowDataBound" 
                        AutoGenerateColumns="False" PageSize="15" 
                           CssClass ="c14072201" onrowdeleting="GridView1_RowDeleting"
                   >
                ...
                <ItemTemplate >
                  <asp:TextBox ID="TextBox1" runat="server"  Text='<%#Eval ("项次") %>'  ReadOnly ="true" CssClass="c14071609"  ></asp:TextBox>   
               ...
               <asp:TemplateField HeaderText="类别名称">
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox14" runat="server" Text='<%#Eval ("可报废量") %>' ReadOnly ="true" CssClass ="c14071701"></asp:TextBox>                     
                </ItemTemplate>
                    <HeaderStyle Width="3%" />
                 <ItemStyle Width="3%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox16" runat="server" Text='<%#Eval ("报废单位") %>'    ReadOnly ="true" CssClass ="c14071616">&gt;</asp:TextBox>                     
                </ItemTemplate>
                   <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="物料料号">
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox111" runat="server" Text='<%#Eval("累计领料量")%>'  ReadOnly ="true"  CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                <HeaderStyle Width="8%" />
                 <ItemStyle Width="8%"  />
            </asp:TemplateField>
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox132" runat="server" Text='<%#Eval ("累计退料量") %>' ReadOnly ="true" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="8%" />
                 <ItemStyle Width="8%"  />
            </asp:TemplateField>
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox131" runat="server" Text='<%#Eval ("累计报废量") %>' ReadOnly ="true" Width ="80px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="8%" />
                 <ItemStyle Width="8%"  />
            </asp:TemplateField>
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox121" runat="server" Text='<%#Eval("工单入库累计耗用量")%>'  ReadOnly ="true" Width ="120px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox18" runat="server" Text='<%#Eval("工单报废累计耗用量")%>'  ReadOnly ="true" Width ="120px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                <HeaderStyle Width="11%" />
                 <ItemStyle Width="11%"  />
            </asp:TemplateField>
              <asp:TemplateField HeaderText="报废单包装报废量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox101" runat="server" Text='<%#Eval ("报废单包装报废量") %>' ReadOnly ="true" Width ="120px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
               <HeaderStyle Width="11%" />
                 <ItemStyle Width="11%"  />
            </asp:TemplateField>
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox20" runat="server" Text='<%#Eval ("库存单位") %>' ReadOnly ="true" Width ="100px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
               <HeaderStyle Width="11%" />
                 <ItemStyle Width="11%"  />
            </asp:TemplateField>
                        <asp:TemplateField HeaderText="本报废单累计报废量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox21" runat="server" Text='<%#Eval ("本报废单累计报废量") %>'  ReadOnly ="true" Width ="120px"
                  CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="11%" />
                 <ItemStyle Width="11%"  />
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox13" runat="server"    Width ="200px"  CssClass ="c13120501"></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField>
          ...
          function f13100202(obj, obj1) {
              ...
              if (obj == "Text5") {
                  ...
                  if (dlgResult != undefined) {
                      ...
                      document.getElementById("Text10").value = dlgResult[7]; /*allow MATERIEL_SCRAP count*/
                  }
