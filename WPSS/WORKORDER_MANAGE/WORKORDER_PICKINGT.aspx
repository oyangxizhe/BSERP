<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WORKORDER_PICKINGT.aspx.cs" Inherits="WPSS.WORKORDER_MANAGE.WORKORDER_PICKINGT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑工单成套领料信息</title>
  ...
  <div class="c13101903" id ="Div38">
     ...
     <div class="c14120504" id ="Div39">
       ...
       <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="Text10" Text="必填" runat="server" />
              ...
              <div class ="c14060302">
                  (未领用量 = 工单包装领用量 - 累计领用量+累计退料量) (领用量默认 = 领料单包装领用量 - 本领料单累计领用量)
           </div>
<div id="i13111001" class ="c14061302">
           <asp:GridView ID="GridView1" runat="server" 
                    ...
                    onrowdatabound="GridView1_RowDataBound" 
                        AutoGenerateColumns="False" PageSize="15" 
                           CssClass ="c14062102" onrowdeleting="GridView1_RowDeleting"
                   >
              ...
              <HeaderStyle Width="2%" />
               ...
               <HeaderStyle Width="4%" />
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox11" runat="server" Text='<%#Eval ("未领用量") %>'   CssClass ="c14071701"></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="3%" />
                 <ItemStyle Width="3%"  />
            </asp:TemplateField> 
                     <asp:TemplateField HeaderText="领用量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox13" runat="server" Text='<%#Eval ("领用量") %>'   CssClass ="c13112302"></asp:TextBox>                     
                </ItemTemplate>
                <HeaderStyle Width="3%" />
                 <ItemStyle Width="3%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox10" runat="server" Text='<%#Eval ("领用单位") %>' ReadOnly ="true" CssClass ="c14071616"></asp:TextBox>                     
                </ItemTemplate>
                <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField>
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox14" runat="server" Text='<%#Eval ("仓库") %>'  CssClass="c14071617"></asp:TextBox>
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox15" runat="server" Text='<%#Eval ("库位") %>' CssClass ="c14120203"></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox16" runat="server" Text='<%#Eval ("批号") %>' CssClass ="c14120203"></asp:TextBox>                     
                </ItemTemplate>
              <HeaderStyle Width="4%" />
                 <ItemStyle Width="4%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox17" runat="server" Text='<%#Eval ("库存数量") %>'    CssClass ="c14071615"></asp:TextBox>                     
                </ItemTemplate>
                <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox18" runat="server" Text='<%#Eval ("库存单位") %>'    ReadOnly ="true" CssClass ="c14071616"></asp:TextBox>                     
                </ItemTemplate>
             <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField> 
            ...
            <HeaderStyle Width="6%" />
              ...
              <asp:TemplateField HeaderText="品牌">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox22" runat="server" Text='<%#Eval ("品牌") %>' ReadOnly ="true" CssClass ="c14070203"></asp:TextBox>                     
                </ItemTemplate>
               <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField> 
        <asp:TemplateField HeaderText="物料料号">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox6" runat="server" Text='<%#Eval ("子客户料号") %>'  ReadOnly ="true" CssClass ="c14070103"></asp:TextBox>                     
                </ItemTemplate>
                <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox7" runat="server" Text='<%#Eval ("生产用量") %>' ReadOnly ="true" CssClass ="c14071615"></asp:TextBox>                     
                </ItemTemplate>
               <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField>
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox8" runat="server" Text='<%#Eval ("BOM单位") %>' ReadOnly ="true" CssClass ="c14071616"></asp:TextBox>                     
                </ItemTemplate>
             <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField>
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox21" runat="server" Text='<%#Eval ("工单包装领用量") %>' ReadOnly ="true" CssClass ="c14071616"></asp:TextBox>                     
                </ItemTemplate>
              <HeaderStyle Width="7%" />
                 <ItemStyle Width="7%"  />
            </asp:TemplateField>
              <asp:TemplateField HeaderText="领料单包装领用量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox9" runat="server" Text='<%#Eval ("领料单包装领用量") %>' ReadOnly ="true" CssClass ="c14071616"></asp:TextBox>                     
                </ItemTemplate>
               <HeaderStyle Width="7%" />
                 <ItemStyle Width="7%"  />
            </asp:TemplateField>
                      ...
                      <asp:TemplateField HeaderText="累计领用量"   >
                <ItemTemplate >
                 <asp:TextBox ID="TextBox12" runat="server" Text='<%#Eval ("累计领用量") %>' ReadOnly ="true" Width ="80px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                <HeaderStyle Width="7%" />
                 <ItemStyle Width="7%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox23" runat="server" Text='<%#Eval ("累计退料量") %>' ReadOnly ="true" Width ="80px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
               <HeaderStyle Width="7%" />
                 <ItemStyle Width="7%"  />
            </asp:TemplateField>
      
                        <asp:TemplateField HeaderText="本领料单累计领用量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox19" runat="server" Text='<%#Eval ("本领料单累计领用量") %>'  ReadOnly ="true" Width ="130px"
               ...
               <HeaderStyle Width="7%" />
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox20" runat="server"    Width ="200px"  CssClass ="c13120501"></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="7%" />
                 <ItemStyle Width="7%"  />
            </asp:TemplateField>
                  ...
                  if (dlgResult != undefined) {
                      ...
                      for (i = 1; i < tr.length; i++) {
                          if (obj1 == i) {
                              ...
                              var v6 = tr[i].getElementsByTagName("td")[8].getElementsByTagName("input")[0];
                              var v7 = tr[i].getElementsByTagName("td")[9].getElementsByTagName("input")[0];
