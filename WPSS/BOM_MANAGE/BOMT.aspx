<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BOMT.aspx.cs" Inherits="WPSS.BOM_MANAGE.BOMT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑BOM表信息</title>
...
<div class ="c13110501">
   ...
   <span class="c13110511" id ="Span6">
    ...
    <asp:LinkButton ID="btnReconcile" runat="server" onclick="btnReconcile_Click" CssClass ="">复制</asp:LinkButton>
       ...
       <div class="c14072402" id ="Div21">
                    <span class="c14072403" id ="Span11">
     <input id="File1" type="file" name="File" runat="server" class ="c14072401" />
    </span>     
   </div>
   ...
   <input id="Text5" type="text"  runat ="server" class ="c14031401" readonly ="readonly" /></div>
    <div class="c13101903" id ="Div38">
     ...
     <div class="c14031403" id ="Div3">
           <input id="Text7" type="text" runat="server" onclick ="f13100202('Text7')"  class ="c14031405"   readonly ="readonly"/></div>
      <div class="c13101903" id ="Div7">
             生效否</div>
     <div class="c14063001" id ="Div8">
          ...
          <asp:GridView ID="GridView1" runat="server" 
           ...
           <asp:TemplateField HeaderText="ID" >
               ...
               <asp:TemplateField HeaderText="物料编码">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox2" runat="server"  Text='<%#Eval ("子料号") %>'  CssClass ="c14070203" ></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="7%"  />
                 <ItemStyle Width="7%" />
            </asp:TemplateField>
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox11" runat="server"  Text='<%#Eval ("品牌") %>' CssClass ="c14113007"></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%" />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox7" runat="server" Text='<%#Eval ("BOM单位") %>' CssClass ="c14113007"></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="4%" />
                 <ItemStyle Width="4%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
               ...
               <HeaderStyle Width="4%" />
                ...
                <HeaderStyle Width="11%" />
                 <ItemStyle Width="11%"  />
                        ...
                        <asp:TemplateField HeaderText="备注">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox10" runat="server"   Text='<%#Eval ("备注") %>' Width ="200px"  CssClass ="c13120501"></asp:TextBox>                     
                </ItemTemplate>
                   <HeaderStyle Width="11%" />
                 <ItemStyle Width="11%"  />
            </asp:TemplateField>
                 ...
                 <ItemStyle Width="6%"  />
                  ...
                  <script type ="text/javascript" >
                      ...
                      function f13100202(obj, obj1) {
                          var dlgResult;
                          if (obj == "Text2") {
                              dlgResult = window.showModalDialog("../BaseInfo/Wareinfo.aspx?CUID=" + document.getElementById("cuid").value + "&nature=bom_mst", window, "dialogWidth:970px; dialogHeight:490px; status:0");
                              ...
                              if (dlgResult != undefined) {
                                  ...
                                  for (i = 1; i < tr1.length; i++) {
                                      if (obj1 == i) {
                                          ...
                                          v5.value = dlgResult[6]; /*dlgResult[3] c_wareid ,dlgResult[11] brand ,dlgResult[6] spec ,dlgResult[8] bom_unit*/
                                          v6.value = dlgResult[11];
