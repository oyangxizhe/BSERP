<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BOM.aspx.cs" Inherits="WPSS.BOM_MANAGE.BOM" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("BOM编号") %>')">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="BOM编号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("BOM编号") %>'></asp:LinkButton>                     
                </ItemTemplate>
            ...
            <asp:BoundField DataField="ID" HeaderText="ID" >
                          ...
                          <asp:BoundField DataField="料号" HeaderText="厂内成品料号" >
                             ...
                             <asp:BoundField DataField="BOM版本" HeaderText="BOM版本" >
                             ...
                             <asp:BoundField DataField="生效否" HeaderText="生效否" >
                              <ItemStyle Width="100px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                          </asp:BoundField>
                              <asp:BoundField DataField="BOM日期" HeaderText="BOM日期" >
                              <ItemStyle Width="100px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                          </asp:BoundField>
                    </Columns>
