<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MATERIALS_TYPE.aspx.cs" Inherits="WPSS.WareNature.MATERIALS_TYPE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>原物料类别信息维护</title>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("MATERIALS_TYPE") %>','<%#Eval ("PURCHASE_PHASE") %>');">
                       选取</a>
                   </ItemTemplate>
              ...
              <asp:TemplateField HeaderText="删除" >
                ...
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("MAID") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 <HeaderStyle Width="80px" />
                 <ItemStyle Width="80px"  ForeColor="#595d5a"/>
            </asp:TemplateField>   
                  <asp:BoundField DataField="MATERIALS_TYPE" HeaderText="原物料类别" >
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                          </asp:BoundField>
               <asp:BoundField DataField="PURCHASE_PHASE" HeaderText="采购周期" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
