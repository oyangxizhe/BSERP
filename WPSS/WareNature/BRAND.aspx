<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BRAND.aspx.cs" Inherits="WPSS.WareNature.BRAND" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("BRAND") %>');">选取</a>
                   </ItemTemplate>
