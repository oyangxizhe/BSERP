<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MATERIALS_TYPET.aspx.cs" Inherits="WPSS.WareNature.MATERIALS_TYPET" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑原物料类别信息</title>
...
<input id="Text1" type="text"  runat="server"   readonly ="readonly" class ="c14031401" /> 
   ...
   <input id="Text3" type="text"  runat ="server" class ="c14120315" /> (周) 
         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="Text3" Text="必填" runat="server" /></div>  
           </div>
