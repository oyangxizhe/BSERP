<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADD_TASK.aspx.cs" Inherits="WPSS.SYSTEM_MANAGE.ADD_TASK" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("ATID") %>','<%#Eval ("AT_NAME") %>','<%#Eval ("PARENT_NODEID") %>',
     '<%#Eval ("PARENT_NAME") %>')">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="作业代码">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("ATID") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 <HeaderStyle Width="60px" />
                 <ItemStyle Width="60px"  ForeColor="#595d5a"/>
            </asp:TemplateField>   
                          <asp:BoundField DataField="AT_NAME" HeaderText="作业名称" >
...
<script type="text/javascript" language="javascript">
    ...
    var Invocation1 = document.getElementById("x").value;
        ...
        if (Invocation1 != "") {
            ...
            document.getElementById("i14072001").style.display = "block";
        }
        else {
            document.getElementById("i14031701").style.display = "none";
            document.getElementById("i14072001").style.display = "none";
        }
    }
