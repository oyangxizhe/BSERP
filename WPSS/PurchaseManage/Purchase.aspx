                ...
                <ItemTemplate >
                 ...
                 <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                          ...
                          <asp:BoundField DataField="PURCHASESTATUS_MST" HeaderText="状态" >
                            ...
                            <asp:BoundField DataField="IF_AUDIT" HeaderText="审核否" >
                              <ItemStyle  CssClass ="c14072502" />
...
<script type="text/javascript" language="javascript">
    ...
    var Invocation1 = document.getElementById("x").value;
        ...
        if (Invocation1 != "") {
            ...
            document.getElementById("i14071701").style.display = "block";

        }
        else {
            document.getElementById("i14031701").style.display = "none";
            document.getElementById("i14071701").style.display = "none";
        }
    }
