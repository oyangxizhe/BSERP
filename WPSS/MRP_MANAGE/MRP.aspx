<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MRP.aspx.cs" Inherits="WPSS.MRP_MANAGE.MRP" %>
               ...
               <asp:BoundField DataField="订单号" HeaderText="订单号" >
                 ...
                 <ItemStyle Width="8%"  />
                           ...
                           <asp:BoundField DataField="订单数量" HeaderText="厂内订单数量"  >
                              <ItemStyle Width="10%"   CssClass="c14070601"/>
...
<script type="text/javascript" language="javascript">
    ...
    var Invocation1 = document.getElementById("x").value;
        ...
        if (Invocation1 != "") {
            ...
            document.getElementById("i14061501").style.display = "block";
        }
        else {
            document.getElementById("i14031701").style.display = "none";
            document.getElementById("i14061501").style.display = "none";
        }
    }
