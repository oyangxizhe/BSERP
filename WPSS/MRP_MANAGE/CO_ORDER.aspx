<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CO_ORDER.aspx.cs" Inherits="WPSS.MRP_MANAGE.CO_ORDER" %>
...
<span id="i13052904"  class ="c13110505"  >
  ...
  <input id="EndDate" type="text" runat="server"  onclick ="f13100202('EndDate')" class ="c14111902" /></div>
   ...
   <span class="c13110505" id ="Span4">
    ...
    <div class ="c13112601" style ="display:none">
     ...
     <div class="c14111903" id ="Div18">
           <asp:DropDownList  ID="DropDownList1" runat="server"   Width ="145px" Height ="25px"  CssClass ="c13111101 ">
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <asp:TemplateField HeaderText="厂内订单号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("厂内订单号") %>'></asp:LinkButton>                     
                </ItemTemplate>
               ...
               <asp:BoundField DataField="订单号" HeaderText="订单号" >
                          ...
                          <asp:BoundField DataField="项次" HeaderText="项次" >
                           ...
                           <asp:BoundField DataField="订单数量" HeaderText="厂内订单数量"  >
                              <ItemStyle Width="100px" ForeColor="#595d5a"  CssClass="c14070601"/>
                                    <HeaderStyle HorizontalAlign="Right" Width="100px" />
                          </asp:BoundField>
                          
                                 <asp:BoundField DataField="客户订单号" HeaderText="客户订单号" >
                              <ItemStyle Width="120px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="120px" HorizontalAlign="Center" />
                          </asp:BoundField>
                             <asp:BoundField DataField="产生MRP否" HeaderText="产生MRP否" >
                              <ItemStyle Width="100px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                          </asp:BoundField>
...
<script type="text/javascript" language="javascript">
    ...
    var Invocation1 = document.getElementById("x").value;
        ...
        if (Invocation1 != "") {
            ...
            document.getElementById("i14071201").style.display = "block";
        }
        else {
            document.getElementById("i14031701").style.display = "none";
            document.getElementById("i14071201").style.display = "none";
