...
<div  class ="c14062101">
           <asp:GridView ID="GridView1" runat="server" 
                    ...
                    onrowdatabound="GridView1_RowDataBound" 
                        AutoGenerateColumns="False"  PageSize="15" 
                           CssClass ="c14073003" onrowdeleting="GridView1_RowDeleting"
                   >
       ...
       <asp:BoundField DataField="客户料号" HeaderText="原厂料号" >
            ...
            <asp:BoundField DataField="入库数量" HeaderText="入库数量" >
                           ...
                           <asp:BoundField DataField="库存单位" HeaderText="入库单位" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"   />
                                    <HeaderStyle Width="80px" HorizontalAlign="Center" />
                          </asp:BoundField>
                  ...
                  if (dlgResult != undefined) {
                      ...
                      for (i = 1; i < tr.length; i++) {
                          if (obj1 == i) {
                              ...
                              var GODE_sku = tr[i].getElementsByTagName("td")[8].getElementsByTagName("input")[0]; /*GODE_sku*/
                              
                              var spec = tr[i].getElementsByTagName("td")[9].getElementsByTagName("input")[0]; /*spec*/
                              var brand = tr[i].getElementsByTagName("td")[10].getElementsByTagName("input")[0]; /*brand*/
                              var cwareid = tr[i].getElementsByTagName("td")[11].getElementsByTagName("input")[0]; /*cwareid*/
