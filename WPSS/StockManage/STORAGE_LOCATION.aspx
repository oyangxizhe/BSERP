<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="STORAGE_LOCATION.aspx.cs" Inherits="WPSS.STOCKMANAGE.STORAGE_LOCATION" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("SLID") %>','<%#Eval ("STORAGE_LOCATION") %>');">选取</a>
                   </ItemTemplate>
