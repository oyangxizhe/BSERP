                ...
                <ItemTemplate >
                 ...
                 <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                          ...
                          <asp:BoundField DataField="StorageName" HeaderText="仓库名称" >
                           ...
                           <asp:BoundField DataField="IFMRP_CALCULATE" HeaderText="MRP有效否" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                                    <HeaderStyle HorizontalAlign="Center" Width="80px" />
                          </asp:BoundField>
                            <asp:BoundField DataField="PURCHASE_GODE" HeaderText="采购入库" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                                    <HeaderStyle HorizontalAlign="Center" Width="80px" />
                          </asp:BoundField>
                            <asp:BoundField DataField="WORKORDER_GODE" HeaderText="工单入库" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                                    <HeaderStyle HorizontalAlign="Center" Width="80px" />
                          </asp:BoundField>
                          <asp:BoundField DataField="WORKORDER_SCRAP" HeaderText="工单报废" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                                    <HeaderStyle HorizontalAlign="Center" Width="80px" />
                          </asp:BoundField>
                            <asp:BoundField DataField="WORKORDER_MATERIEL_SCRAP" HeaderText="工单物料报废" >
