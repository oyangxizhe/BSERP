<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WareInfo_wo.aspx.cs" Inherits="WPSS.BaseInfo.WareInfo_wo" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
     ...
     '<%#Eval ("REMARK") %>','<%#Eval ("BOM_UNIT") %>','<%#Eval ("PURCHASEUNITPRICE") %>','<%#Eval ("BOM_UNIT") %>','<%#Eval ("BRAND") %>'
     ,'<%#Eval ("BOID") %>','<%#Eval ("BOM_EDITION") %>')">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:BoundField DataField="CO_WAREID" HeaderText="厂内成品料号(原物料编码)" >
                              <ItemStyle Width="170px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="170px" />
                          </asp:BoundField>
                          <asp:BoundField DataField="WNAME" HeaderText="品名(原物料类别)" >
                    ...
                    <asp:BoundField DataField="SPEC" HeaderText="规格" >
                          ...
                          <asp:BoundField DataField="BRAND" HeaderText="品牌" >
                           ...
                           <asp:BoundField DataField="CWAREID" HeaderText="客户料号(原厂料号)" >
...
<script type="text/javascript" language="javascript">
    var arr1 = new Array();
    var arr2 = new Array();
    function f13100302(obj, obj1, obj2, obj3,obj4,obj5,obj6,obj7,obj8,obj9,obj10,obj11,obj12,obj13) {
