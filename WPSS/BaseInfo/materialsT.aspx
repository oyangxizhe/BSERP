<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="materialsT.aspx.cs" Inherits="WPSS.BaseInfo.materialsT" %>
...
<body >
   ...
   <span class="c13110511" id ="Span6">
    ...
    <asp:LinkButton ID="btnReconcile" runat="server" onclick="btnReconcile_Click" CssClass ="">复制</asp:LinkButton>
             ...
             <div class="c14072402" id ="Div34">
                    <span class="c14072403" id ="Span11">
     <input id="File1" type="file" name="File" runat="server" class ="c14072401"  style="display:none "/>
    </span>     
   </div>
 
          <div class="c13110507" id ="Div42" style ="display:none ;">
                  <span class="c13110503" id ="Span8">
     <asp:ImageButton ID="btnEXCEL_IMPORT" 
                 runat="server" ImageUrl="~/Image/Excel_big.png" Width="60px" 
                      onclick="btnEXCEL_IMPORT_Click"   />
          </span>
   </div>
...
<div class="c14120501" id ="Div3">
   <span style =" margin-right :8px;">
   <asp:DropDownList ID="DropDownList5" runat="server" CssClass="c14062705">
   </asp:DropDownList>
   <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="DropDownList5" Text="必填" runat="server" /></span>
         </div>
           </div>
             <div class ="c13101902">
  ...
  <asp:DropDownList ID="DropDownList1" runat="server" CssClass="c14031402" Height="20px">
      ...
      <asp:ListItem>作废</asp:ListItem>
               ...
               <div class="c13122302" id ="Div20">
                    采购周期(周)</div>
<div class="c14031403" id ="Div35"> <span style =" margin-right :8px;">
<input id="Text8" type="text"  runat="server"  class ="c14031405"/> 
         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="Text8" Text="必填" runat="server" /></span></div>
               <div class="c13122302" id ="Div40">
                    最小采购量</div>
<div class="c14031403" id ="Div41"> 
<input id="Text11" type="text"  runat="server"  class ="c14031405"/> 
         </div>
           </div>
           <div class ="c13101902">
                          <div class="c13122302" id ="Div24" >
                              1个采购单位</div>
     <div class="c14062704" id ="Div25">
   <span style =" margin-right :8px;">
   <asp:DropDownList ID="DropDownList2" runat="server"  CssClass="c14062705">
     ...
     <div class="c14062704" id ="Div29">
     <span style =" margin-right :8px;"><input id="Text6" type="text"  runat ="server" class ="c14031405"  /> 
  </span> 
         </div>
                                 <div class="c14062703" id ="Div30">
                                                                          个库存单位</div>
    
     <div class="c14062704" id ="Div31"><span style =" margin-right :8px;">
  <asp:DropDownList ID="DropDownList3" runat="server"  CssClass="c14062705" Height="20px">
  
                    </asp:DropDownList></span> 
         </div>
                             <div class="c14062702" id ="Div32">
                     <span style =" margin-right :15px; margin-left:10px;" >=</span></div>
<div class="c14062704" id ="Div33">
<span style =" margin-right :8px;">
  <input id="Text7" type="text"  runat ="server" class ="c14031405"  /> 
  </span> 
         </div>
                  <div class="c14062703" id ="Div9" >
                      个BOM单位</div>
...
<script type="text/javascript" language="javascript">
    ...
    function f13100202(obj, obj1) {
        var dlgResult;
        if (obj == "Text3") {
            dlgResult = window.showModalDialog("../warenature/materials_type.aspx", window, "dialogWidth:970px; dialogHeight:490px; status:0");
