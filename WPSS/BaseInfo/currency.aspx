<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CURRENCY.aspx.cs" Inherits="WPSS.BaseInfo.CURRENCY" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("CURRENCY") %>');">选取</a>
                   </ItemTemplate>
          ...
          <div id="i14081201" class ="c13102303">
