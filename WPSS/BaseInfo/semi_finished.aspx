<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="semi_finished.aspx.cs" Inherits="WPSS.BaseInfo.semi_finished" %>
     ...
     '<%#Eval ("CWAREID") %>','<%#Eval ("CNAME") %>','<%#Eval ("SELLUNITPRICE") %>','<%#Eval ("SPEC") %>','<%#Eval ("REMARK") %>')">
             ...
             <asp:BoundField DataField="CO_WAREID" HeaderText="厂内成品料号" >
                              <ItemStyle  ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" CssClass="c14070204" />
                          </asp:BoundField>
                          <asp:BoundField DataField="WNAME" HeaderText="品名" >
                             ...
                             <asp:BoundField DataField="SPEC" HeaderText="规格" >
                              <ItemStyle  ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center"  CssClass ="c14113008" />
                          </asp:BoundField>
                             <asp:BoundField DataField="CUSTOMER_ID" HeaderText="客户代码" >
