<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="materials.aspx.cs" Inherits="WPSS.BaseInfo.materials" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
     ...
     '<%#Eval ("CWAREID") %>','<%#Eval ("SNAME") %>','<%#Eval ("SELLUNITPRICE") %>','<%#Eval ("SPEC") %>','<%#Eval ("REMARK") %>')">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:BoundField DataField="CO_WAREID" HeaderText="原物料编码" >
                              <ItemStyle Width="120px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="120px" />
                          </asp:BoundField>
                          <asp:BoundField DataField="WNAME" HeaderText="原物料类别" >
                              <ItemStyle Width="80px" ForeColor="#595d5a" />
                            ...
                            <asp:BoundField DataField="SPEC" HeaderText="规格" >
                             ...
                             <asp:BoundField DataField="BRAND" HeaderText="品牌" >
                              <ItemStyle Width="100px" ForeColor="#595d5a" />
                                    <HeaderStyle Width="100px" HorizontalAlign="Center" CssClass ="c14073002"/>
                          </asp:BoundField>
                      
                    <asp:BoundField DataField="CWAREID" HeaderText="原厂料号" >
                              <ItemStyle Width="100px" ForeColor="#595d5a" />
