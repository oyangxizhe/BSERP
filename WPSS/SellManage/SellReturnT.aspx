...
<div class ="c13111602" id="i13122801">
     ...
     <div class="c13122801" id ="Div36">
      <span style="color :#990033;float :left ;">
         注：由于销退含只销退金额不销退数量的需求，所以销退未税金额，销退税额，销退含税金额都需用户自己输入。销退数量与销退金额无直接关联</span>
           ...
           <HeaderStyle Width="5%" />
               ...
               <HeaderStyle Width="5%" />
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox26" runat="server" Text='<%#Eval ("库位") %>'    CssClass ="c14071617"></asp:TextBox>
                 <a  href="javascript:f13100202('TextBox26','<%#Eval ("项次") %>');">选择 </a>                     
                </ItemTemplate>
                                 <HeaderStyle Width="5%" />
                 <ItemStyle Width="5%"  />
            </asp:TemplateField> 
             ...
             <asp:TemplateField HeaderText="销退未税" >
                <ItemTemplate >
                 <asp:TextBox ID="TextBox23" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "销退未税金额", "{0:F2}")%>' CssClass ="c13112302"></asp:TextBox>                     
                </ItemTemplate>
                         <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox24" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "销退税额", "{0:F2}")%>'  CssClass ="c13112302"></asp:TextBox>                     
                </ItemTemplate>
                         <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox25" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "销退含税金额", "{0:F2}")%>' CssClass ="c13112302"></asp:TextBox>                     
                </ItemTemplate>
                         <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField> 
      ...
      <asp:TemplateField HeaderText="ID" >
              ...
              <asp:TemplateField HeaderText="规格">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox4" runat="server" Text='<%#Eval ("规格") %>' ReadOnly ="true" CssClass="c14071611" ></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField> 
        ...
        <asp:TemplateField HeaderText="客户料号">
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox14" runat="server" Text='<%#Eval("累计销货数量")%>'  ReadOnly ="true"  CssClass="c14071615"></asp:TextBox>                     
                </ItemTemplate>
                     <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox10" runat="server" Text='<%#Eval ("累计销退数量") %>' ReadOnly ="true" CssClass="c14071615"></asp:TextBox>                     
                </ItemTemplate>
                    <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField>
               <asp:TemplateField HeaderText="可销退量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox9" runat="server" Text='<%#Eval ("可销退数量") %>' ReadOnly ="true"  CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                    <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  />
            </asp:TemplateField> 
                        <asp:TemplateField HeaderText="本销退单累计销退数量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox15" runat="server" Text='<%#Eval ("本销退单累计销退数量") %>'  ReadOnly ="true" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle Width="6%"  />
                            ...
                            <asp:TemplateField HeaderText="累计销退未税金额" >
                <ItemTemplate >
                 <asp:TextBox ID="TextBox17" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "累计销退未税金额", "{0:F2}")%>'   CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                  <HeaderStyle Width="11%" />
                 <ItemStyle Width="11%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox18" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "累计销退税额", "{0:F2}")%>'   width="130px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                   <HeaderStyle Width="11%" />
                 <ItemStyle Width="11%"  />
            </asp:TemplateField> 
                       <asp:TemplateField HeaderText="累计销退含税金额">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox19" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "累计销退含税金额", "{0:F2}")%>'  width="130px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                   <HeaderStyle Width="11%" />
                 <ItemStyle Width="11%"  />
            </asp:TemplateField> 
               <asp:TemplateField HeaderText="可销退未税金额" >
                <ItemTemplate >
                 <asp:TextBox ID="TextBox20" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "可销退未税金额", "{0:F2}")%>'    width="130px"  CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                    <HeaderStyle Width="11%" />
                 <ItemStyle Width="11%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox21" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "可销退税额", "{0:F2}")%>'   width="130px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
                    <HeaderStyle Width="11%" />
                 <ItemStyle Width="11%"  />
            </asp:TemplateField> 
                       <asp:TemplateField HeaderText="可销退含税金额">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox22" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "可销退含税金额", "{0:F2}")%>' width="130px" CssClass ="c13112503"></asp:TextBox>                     
                </ItemTemplate>
               <HeaderStyle Width="11%" />
                 <ItemStyle Width="11%"  />
            </asp:TemplateField> 
   ...
   <input id="Text9" type="text"  runat ="server" class ="c13102908"  /> 
      ...
      <script type ="text/javascript" >
          ...
          function f13100202(obj, obj1) {
              var dlgResult;
              if (obj == "Text2") {
                  dlgResult = window.showModalDialog("../SellManage/order.aspx", window, "dialogWidth:970px; dialogHeight:490px; status:0");
                  ...
                  if (dlgResult != undefined) {
                      ...
                      for (i = 1; i < tr1.length; i++) {
                          if (obj1 == i) {
                              var v51 = tr1[i].getElementsByTagName("td")[6].getElementsByTagName("input")[0];
                              v51.value = dlgResult[1];
                              break;
                          }
                      }
                  }
