...
<input id="Text1" type="text"  runat="server"   readonly ="readonly" class="c13112201"/> 
         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="Text1" Text="必填！" runat="server" /></div>
          ...
          客户代码</div>
     <div class="c13101904" id ="Div30">
<input id="Text9" type="text"  runat="server" class ="c14031405" /> 
<asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="Text9" Text="必填" runat="server" />
        </div>
   ...
   <input id="Text4" type="text"  runat ="server"   readonly ="readonly" class="c13112201" /> 
     ...
     <div class="c13101904" id ="Div32" style="display:none ">
   ...
   <asp:DropDownList ID="DropDownList1" runat="server" CssClass="c14040702">
        ...
        <div class ="c13101902">
                  <div class="c13101903" id ="Div20">
                      公司地址</div>
     <div class="c14081102" id ="Div23">
                    <input id="Text8" type="text"  runat="server"  readonly ="readonly" class="c14081101"/></div>
